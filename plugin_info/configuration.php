...
<form class="form-horizontal">
	...
	<div class="form-group">
 	    ...
 	    <div class="col-lg-2">
  	      <a class="btn btn-default" id="bt_syncMyStrom"><i class='fa fa-refresh'></i> {{Rechercher les équipements MyStrom}}</a>
	    </div>
	</div>
  </fieldset>
</form>
...
<script>
 $('#bt_syncMyStrom').on('click', function () {
        $.ajax({// fonction permettant de faire de l'ajax
            type: "POST", // methode de transmission des données au fichier php
            url: "plugins/mystrom/core/ajax/mystrom.ajax.php", // url du fichier php
            data: {
            	action: "syncMyStrom",
            },
            dataType: 'json',
