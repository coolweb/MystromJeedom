...
class mystrom extends eqLogic {
    ...
    public function pull($_eqLogic_id = null) {
      ...
      foreach (mystrom::$_eqLogics as $eqLogic) {
        ...
        /*$eqLogic->getCmd(null, 'on')->setConfiguration('lastCmdValue', $foundMystromDevice->state);
        $eqLogic->getCmd(null, 'off')->setConfiguration('lastCmdValue', $foundMystromDevice->state);*/
        /*$eqLogic->getCmd(null, 'on')->setValue($eqLogic->getCmd(null, 'state'));
        $eqLogic->getCmd(null, 'off')->setValue($eqLogic->getCmd(null, 'state'));*/
    ...
    public function toHtml($_version = 'dashboard') {
      ...
      $html = template_replace($replace, getTemplate('core', $version, 'eqLogic'));
      log::add('mystrom', 'debug', 'Html:' . $html);
